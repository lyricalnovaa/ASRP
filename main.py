...
guild_whitelist = [
    ...
    "1342348906289299466", "1343642362148163665", "1344866545997840506"
]
...
ROLE_IDS = {
    ...
    1344866545997840506: {
        ...
        "strike1": 1342056499295551520,
        "strike2": 1342056386313453631,
        "strike3": 1344866546014486632,
    },
    # Main Server Guild
    1341314653372022804: {
        "warning1": 1342056784797499466,
        "warning2": 1342056899394408498,
        "warning3": 1342057006843822152,
        "strike1": 1342061849377509511,
        "strike2": 1342061849377509510,
        "strike3": 1342061849377509509,
    },
    # ASP Guild
    1342061849352605806: {
        "warning1": 1342061849377509507,
        "warning2": 1342061849377509506,
        "warning3": 1342061849352605815,
        "strike1": 1342056263269224448,
...
@bot.command()
@is_hr()
async def infract(ctx, user: discord.User, current_rank_id: int, callsign: str, punishment: str, reason: str, approved_by: discord.User, *, notes: str):
